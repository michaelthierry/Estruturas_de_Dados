...
typedef struct elemento{
    //Campo que é um ponteiro para o elemento anterior
    struct elemento *anterior;
    //campo que guarda o valor
    Dado elemento;
    //campo para o proximo elemento
    struct elemento *proximo;
}Elemento;

/*Estrutura da Lista Linear Dinamica*/
typedef struct lista{
    //Campo para o primeiro elemento da lista
    Elemento *inicio;
}Lista;
